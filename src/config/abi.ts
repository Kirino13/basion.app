// BasionV2 Contract ABI - UUPS Upgradeable Proxy
// Contract Address: 0x6bdd40883a4828DfFcE33C3A2222a0eFd31DFe1A
...
export const BASION_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'isPremium', type: 'bool' },
    ],
    name: 'Tap',
    type: 'event',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'bool', name: 'isBatch', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      { internalType: 'uint256', name: '_referrerMult', type: 'uint256' },
      { internalType: 'uint256', name: '_referredMult', type: 'uint256' },
    ],
